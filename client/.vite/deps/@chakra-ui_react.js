import {
  require_prop_types
} from "./chunk-NIBSDFOE.js";
import {
  require_react_dom
} from "./chunk-2RTH7GEI.js";
import {
  CSSVars,
  ColorModeContext,
  ColorModeProvider,
...
} from "./chunk-CCBFOA2T.js";
import "./chunk-CMK54ICT.js";
import {
  require_react
...
var DOMVisualElement = class extends VisualElement {
  ...
  makeTargetAnimatableFromInstance({ transition: transition2, transitionEnd, ...target }, isMounted) {
    const origin = getOrigin(target, transition2 || {}, this);
    if (isMounted) {
...
var Wrap = forwardRef(function Wrap2(props, ref) {
  ...
  const _children = (0, import_react122.useMemo)(
    () => shouldWrapChildren ? import_react122.Children.map(children, (child, index2) => (0, import_jsx_runtime71.jsx)(WrapItem, { children: child }, index2)) : children,
...
var Stack = forwardRef((props, ref) => {
  ...
  const clones = (0, import_react123.useMemo)(() => {
    ...
    return shouldUseChildren ? validChildren : validChildren.map((child, index2) => {
      ...
      return (0, import_jsx_runtime74.jsxs)(import_react123.Fragment, { children: [
        _child,
        _divider
      ] }, key);
    });
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime80.jsx)(import_jsx_runtime80.Fragment, { children: chunks.map((chunk, index2) => {
    return chunk.match ? (0, import_jsx_runtime80.jsx)(Mark, { sx: styles, children: chunk.text }, index2) : (0, import_jsx_runtime80.jsx)(import_react124.Fragment, { children: chunk.text }, index2);
  }) });
}
...
var Indicator = forwardRef(function Indicator2(props, ref) {
  ...
  const styles = (0, import_react125.useMemo)(
    () => ({
      display: "inline-flex",
      justifyContent: "center",
      alignItems: "center",
...
var AspectRatio = forwardRef(function(props, ref) {
  ...
  const child = import_react126.Children.only(children);
...
function useMediaQuery(query, options = {}) {
  ...
  const [value, setValue] = (0, import_react127.useState)(() => {
...
function useShortcut2(props = {}) {
  const { timeout = 300, preventDefault = () => true } = props;
  const [keys, setKeys] = (0, import_react128.useState)([]);
  const timeoutRef = (0, import_react128.useRef)();
  const flush = () => {
    if (timeoutRef.current) {
      clearTimeout(timeoutRef.current);
      timeoutRef.current = null;
  ...
  (0, import_react128.useEffect)(() => flush, []);
  function onKeyDown(fn2) {
    return (event) => {
      if (event.key === "Backspace") {
        const keysCopy = [...keys];
...
function useEventListeners() {
  const listeners = (0, import_react129.useRef)(/* @__PURE__ */ new Map());
  const currentListeners = listeners.current;
  const add = (0, import_react129.useCallback)((el, type, listener, options) => {
    listeners.current.set(listener, { type, el, options });
    el.addEventListener(type, listener, options);
  }, []);
  const remove = (0, import_react129.useCallback)(
    (el, type, listener, options) => {
...
function useClickable(props = {}) {
  ...
  const [isButton, setIsButton] = (0, import_react130.useState)(true);
  const [isPressed, setIsPressed] = (0, import_react130.useState)(false);
  ...
  const trulyDisabled = isDisabled2 && !isFocusable2;
  const handleClick = (0, import_react130.useCallback)(
    (event) => {
      if (isDisabled2) {
        event.stopPropagation();
        event.preventDefault();
  ...
  const onDocumentKeyUp = (0, import_react130.useCallback)(
    (e) => {
  ...
  const handleKeyUp = (0, import_react130.useCallback)(
    (event) => {
  ...
  const onDocumentMouseUp = (0, import_react130.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      setIsPressed(false);
  ...
  const handleMouseDown = (0, import_react130.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      if (isDisabled2) {
  ...
  const handleMouseUp = (0, import_react130.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      if (!isButton) {
  ...
  const handleMouseOver = (0, import_react130.useCallback)(
    (event) => {
      if (isDisabled2) {
        event.preventDefault();
        return;
  ...
  const handleMouseLeave = (0, import_react130.useCallback)(
    (event) => {
      if (isPressed) {
        event.preventDefault();
        setIsPressed(false);
...
function useFocusOnShow2(target, options = defaultOptions2) {
  ...
  const autoFocusValue = shouldFocus && visible;
  const autoFocusRef = (0, import_react131.useRef)(autoFocusValue);
  const lastVisibleRef = (0, import_react131.useRef)(visible);
  useSafeLayoutEffect(() => {
    if (!lastVisibleRef.current && visible) {
      autoFocusRef.current = autoFocusValue;
    }
  ...
  const onFocus3 = (0, import_react131.useCallback)(() => {
    if (!visible || !element || !autoFocusRef.current)
      return;
    autoFocusRef.current = false;
...
function usePopper(props = {}) {
  ...
  const reference2 = (0, import_react132.useRef)(null);
  const popper2 = (0, import_react132.useRef)(null);
  const instance = (0, import_react132.useRef)(null);
  const placement = getPopperPlacement(placementProp, direction);
  const cleanup = (0, import_react132.useRef)(() => {
  });
  const setupPopper = (0, import_react132.useCallback)(() => {
    var _a2;
  ...
  const referenceRef = (0, import_react132.useCallback)(
    (node2) => {
  ...
  const getReferenceProps = (0, import_react132.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const popperRef = (0, import_react132.useCallback)(
    (node2) => {
  ...
  const getPopperProps = (0, import_react132.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const getArrowProps = (0, import_react132.useCallback)((props2 = {}, ref = null) => {
  ...
  const getArrowInnerProps = (0, import_react132.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      ref,
      "data-popper-arrow-inner": ""
...
function useDisclosure2(props = {}) {
  ...
  const [isOpenState, setIsOpen] = (0, import_react133.useState)(props.defaultIsOpen || false);
  const isOpen = isOpenProp !== void 0 ? isOpenProp : isOpenState;
  const isControlled = isOpenProp !== void 0;
  const uid = (0, import_react133.useId)();
  const id3 = idProp != null ? idProp : `disclosure-${uid}`;
  const onClose = (0, import_react133.useCallback)(() => {
    if (!isControlled) {
      setIsOpen(false);
    }
    handleClose == null ? void 0 : handleClose();
  }, [isControlled, handleClose]);
  const onOpen = (0, import_react133.useCallback)(() => {
    if (!isControlled) {
      setIsOpen(true);
    }
...
function useOutsideClick2(props) {
  ...
  const stateRef = (0, import_react134.useRef)({
    isPointerDown: false,
    ignoreEmulatedMouseEvents: false
  });
  const state = stateRef.current;
...
function useAnimationState2(props) {
  const { isOpen, ref } = props;
  const [mounted, setMounted] = (0, import_react135.useState)(isOpen);
  const [once, setOnce] = (0, import_react135.useState)(false);
...
function useMenu(props = {}) {
  ...
  const rafId = (0, import_react136.useRef)(null);
  return {
    openAndFocusMenu,
...
var StyledMenuItem = forwardRef(
  (props, ref) => {
    ...
    const buttonStyles = (0, import_react138.useMemo)(
      () => ({
        textDecoration: "none",
        color: "inherit",
        userSelect: "none",
...
var MenuIcon = (props) => {
  ...
  const styles = useMenuStyles();
  const child = import_react139.Children.only(children);
  const clone = (0, import_react139.isValidElement)(child) ? (0, import_react139.cloneElement)(child, {
    focusable: "false",
    "aria-hidden": true,
...
var ModalTransition = (0, import_react140.forwardRef)(
  (props, ref) => {
...
function useModalManager(ref, isOpen) {
  const [index2, setIndex] = (0, import_react141.useState)(0);
...
function useModal(props) {
  ...
  const dialogRef = (0, import_react142.useRef)(null);
  const overlayRef = (0, import_react142.useRef)(null);
  ...
  const mouseDownTarget = (0, import_react142.useRef)(null);
  const onMouseDown = (0, import_react142.useCallback)((event) => {
  ...
  const [headerMounted, setHeaderMounted] = (0, import_react142.useState)(false);
  const [bodyMounted, setBodyMounted] = (0, import_react142.useState)(false);
  const getDialogProps = (0, import_react142.useCallback)(
    (props2 = {}, ref = null) => ({
      role: "dialog",
      ...props2,
  ...
  const onOverlayClick = (0, import_react142.useCallback)(
    (event) => {
      event.stopPropagation();
  ...
  const getDialogContainerProps = (0, import_react142.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
...
function useSpinner(increment, decrement) {
  const [isSpinning, setIsSpinning] = (0, import_react148.useState)(false);
  const [action, setAction] = (0, import_react148.useState)(null);
  const [runOnce, setRunOnce] = (0, import_react148.useState)(true);
  const timeoutRef = (0, import_react148.useRef)(null);
  ...
  const up = (0, import_react148.useCallback)(() => {
    if (runOnce) {
      increment();
    }
    timeoutRef.current = setTimeout(() => {
  ...
  const down = (0, import_react148.useCallback)(() => {
    if (runOnce) {
      decrement();
    }
    timeoutRef.current = setTimeout(() => {
  ...
  const stop = (0, import_react148.useCallback)(() => {
    setRunOnce(true);
    setIsSpinning(false);
    removeTimeout();
  }, []);
...
function useNumberInput(props = {}) {
  ...
  const [isFocused, setFocused] = (0, import_react149.useState)(false);
  const isInteractive = !(isReadOnly || isDisabled2);
  const inputRef = (0, import_react149.useRef)(null);
  const inputSelectionRef = (0, import_react149.useRef)(null);
  const incrementButtonRef = (0, import_react149.useRef)(null);
  const decrementButtonRef = (0, import_react149.useRef)(null);
  const sanitize2 = (0, import_react149.useCallback)(
    (value) => value.split("").filter(isValidCharacter).join(""),
    [isValidCharacter]
  );
  const parse3 = (0, import_react149.useCallback)(
    (value) => {
      var _a2;
  ...
  const format = (0, import_react149.useCallback)(
    (value) => {
      var _a2;
  ...
  const increment = (0, import_react149.useCallback)(
    (step = stepProp) => {
      if (isInteractive) {
        incrementFn(step);
      }
  ...
  const decrement = (0, import_react149.useCallback)(
    (step = stepProp) => {
      if (isInteractive) {
        decrementFn(step);
      }
  ...
  const onChange = (0, import_react149.useCallback)(
    (event) => {
  ...
  const _onFocus = (0, import_react149.useCallback)(
    (event) => {
      var _a2, _b, _c;
  ...
  const ariaValueText = (0, import_react149.useMemo)(() => {
  ...
  const validateAndClamp = (0, import_react149.useCallback)(() => {
  ...
  const onInputBlur = (0, import_react149.useCallback)(() => {
    setFocused(false);
    if (clampValueOnBlur) {
      validateAndClamp();
    }
  }, [clampValueOnBlur, setFocused, validateAndClamp]);
  const focusInput = (0, import_react149.useCallback)(() => {
  ...
  const spinUp = (0, import_react149.useCallback)(
    (event) => {
      event.preventDefault();
      spinner.up();
      focusInput();
  ...
  const spinDown = (0, import_react149.useCallback)(
    (event) => {
      event.preventDefault();
      spinner.down();
      focusInput();
  ...
  const getIncrementButtonProps = (0, import_react149.useCallback)(
    (props2 = {}, ref = null) => {
  ...
  const getDecrementButtonProps = (0, import_react149.useCallback)(
    (props2 = {}, ref = null) => {
...
var NumberInput = forwardRef(
  function NumberInput2(props, ref) {
    ...
    const ctx = (0, import_react150.useMemo)(() => context, [context]);
...
function usePinInput(props = {}) {
  ...
  const [moveFocus, setMoveFocus] = (0, import_react151.useState)(true);
  ...
  const focusNext = (0, import_react151.useCallback)(
    (index2) => {
  ...
  const setValue = (0, import_react151.useCallback)(
  ...
  const clear = (0, import_react151.useCallback)(() => {
    var _a2;
  ...
  const getNextValue = (0, import_react151.useCallback)((value2, eventValue) => {
  ...
  const getInputProps = (0, import_react151.useCallback)(
    (props2) => {
...
function PinInput(props) {
  ...
  const clones = getValidChildren(children).map(
    (child) => (0, import_react152.cloneElement)(child, { __css: styles })
  );
...
function PopoverTrigger(props) {
  ...
  return (0, import_react153.cloneElement)(child, getTriggerProps(child.props, child.ref));
}
...
function usePopover(props = {}) {
  ...
  const anchorRef = (0, import_react154.useRef)(null);
  const triggerRef = (0, import_react154.useRef)(null);
  const popoverRef = (0, import_react154.useRef)(null);
  const isHoveringRef = (0, import_react154.useRef)(false);
  const hasBeenOpened = (0, import_react154.useRef)(false);
  if (isOpen) {
    hasBeenOpened.current = true;
  }
  const [hasHeader, setHasHeader] = (0, import_react154.useState)(false);
  const [hasBody, setHasBody] = (0, import_react154.useState)(false);
  ...
  const getPopoverProps = (0, import_react154.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const popoverProps = {
        ...props2,
        style: {
  ...
  const getPopoverPositionerProps = (0, import_react154.useCallback)(
  ...
  const getAnchorProps = (0, import_react154.useCallback)(
    (props2, _ref2 = null) => {
      return {
        ...props2,
  ...
  const openTimeout = (0, import_react154.useRef)();
  const closeTimeout = (0, import_react154.useRef)();
  const maybeReferenceRef = (0, import_react154.useCallback)(
    (node2) => {
  ...
  const getTriggerProps = (0, import_react154.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const triggerProps = {
        ...props2,
  ...
  const getHeaderProps = (0, import_react154.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      id: headerId,
  ...
  const getBodyProps = (0, import_react154.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      id: bodyId,
      ref: mergeRefs(ref, (node2) => {
...
function PopoverAnchor(props) {
  const child = import_react155.Children.only(props.children);
  const { getAnchorProps } = usePopoverContext();
  return (0, import_react155.cloneElement)(child, getAnchorProps(child.props, child.ref));
}
...
function useRadioGroup(props = {}) {
  ...
  const [valueState, setValue] = (0, import_react156.useState)(defaultValue || "");
  const isControlled = typeof valueProp !== "undefined";
  const value = isControlled ? valueProp : valueState;
  const ref = (0, import_react156.useRef)(null);
  const focus2 = (0, import_react156.useCallback)(() => {
  ...
  const onChange = (0, import_react156.useCallback)(
    (eventOrValue) => {
  ...
  const getRootProps = (0, import_react156.useCallback)(
    (props2 = {}, forwardedRef = null) => ({
      ...props2,
...
var RadioGroup = forwardRef((props, ref) => {
  ...
  const group = (0, import_react157.useMemo)(
    () => ({
      name,
      size,
      onChange,
...
function useRadio(props = {}) {
  ...
  const uuid = `radio-${(0, import_react158.useId)()}`;
  ...
  const [isFocusVisible2, setIsFocusVisible] = (0, import_react158.useState)(false);
  const [isFocused, setFocused] = (0, import_react158.useState)(false);
  const [isHovered, setHovering] = (0, import_react158.useState)(false);
  const [isActive, setActive] = (0, import_react158.useState)(false);
  const [isCheckedState, setChecked] = (0, import_react158.useState)(Boolean(defaultChecked));
  const isControlled = typeof isCheckedProp !== "undefined";
  const isChecked = isControlled ? isCheckedProp : isCheckedState;
  (0, import_react158.useEffect)(() => {
    return trackFocusVisible(setIsFocusVisible);
  }, []);
  const handleChange = (0, import_react158.useCallback)(
    (event) => {
      if (isReadOnly || isDisabled2) {
        event.preventDefault();
        return;
  ...
  const onKeyUp = (0, import_react158.useCallback)(
    (event) => {
      if (event.key === " ") {
        setActive(false);
      }
  ...
  const getRadioProps = (0, import_react158.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      ref,
      "data-active": dataAttr(isActive),
  ...
  const getInputProps = (0, import_react158.useCallback)(
    (props2 = {}, ref = null) => {
      const trulyDisabled = isDisabled2 && !isFocusable2;
      return {
        ...props2,
...
var SelectIcon = (props) => {
  ...
  const clone = (0, import_react159.cloneElement)(children, {
    role: "presentation",
  ...
  return (0, import_jsx_runtime135.jsx)(IconWrapper, { ...rest, className: "chakra-select__icon-wrapper", children: (0, import_react159.isValidElement)(children) ? clone : null });
};
...
function usePrevious2(value) {
  const ref = (0, import_react161.useRef)();
...
var SkeletonText = (props) => {
  ...
  return (0, import_jsx_runtime138.jsx)(chakra.div, { className: _className, ...rest, children: numbers.map((number2, index2) => {
...
function usePanEvent(ref, options) {
  ...
  const panSession = (0, import_react163.useRef)(null);
...
var useSafeLayoutEffect4 = Boolean(globalThis == null ? void 0 : globalThis.document) ? import_react164.useLayoutEffect : import_react164.useEffect;
...
function useSizes({
  ...
  const [sizes, setSizes] = (0, import_react164.useState)([]);
  const [count, setCount] = (0, import_react164.useState)(0);
...
function useRangeSlider(props) {
  ...
  const [activeIndex, setActiveIndex] = (0, import_react165.useState)(-1);
  const isInteractive = !(isDisabled2 || isReadOnly);
  const initialValue = (0, import_react165.useRef)(valueState);
  ...
  const getOutputProps = (0, import_react165.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
...
var RangeSlider = forwardRef(
  function RangeSlider2(props, ref) {
    ...
    const ctx = (0, import_react166.useMemo)(
...
function useSlider(props) {
  ...
  const [isDragging, setDragging] = (0, import_react167.useState)(false);
  ...
  const trackRef = (0, import_react167.useRef)(null);
  const thumbRef = (0, import_react167.useRef)(null);
  const rootRef = (0, import_react167.useRef)(null);
  const reactId = (0, import_react167.useId)();
  const uuid = idProp != null ? idProp : reactId;
  const [thumbId, trackId] = [`slider-thumb-${uuid}`, `slider-track-${uuid}`];
  const getValueFromPointer = (0, import_react167.useCallback)(
    (event) => {
      var _a22, _b;
      if (!trackRef.current)
        return;
  ...
  const constrain = (0, import_react167.useCallback)(
    (value2) => {
      const state2 = stateRef.current;
  ...
  const actions = (0, import_react167.useMemo)(
    () => ({
  ...
  const { getThumbStyle, rootStyle, trackStyle, innerTrackStyle } = (0, import_react167.useMemo)(() => {
    const state2 = stateRef.current;
  ...
  const focusThumb = (0, import_react167.useCallback)(() => {
    const state2 = stateRef.current;
  ...
  const getRootProps = (0, import_react167.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ...htmlProps,
  ...
  const getTrackProps = (0, import_react167.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref: mergeRefs(ref, trackRef),
  ...
  const getInnerTrackProps = (0, import_react167.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
  ...
  const getThumbProps = (0, import_react167.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
  ...
  const getMarkerProps = (0, import_react167.useCallback)(
    (props2, ref = null) => {
...
var Stepper = forwardRef(function Stepper2(props, ref) {
  ...
  const stepElements = import_react168.Children.toArray(children);
  ...
  return (0, import_jsx_runtime150.jsx)(
    chakra.div,
    {
      ...
      children: (0, import_jsx_runtime150.jsx)(StepperStylesProvider, { value: styles, children: stepElements.map((child, index22) => (0, import_jsx_runtime150.jsx)(
        StepContextProvider,
        {
          value: {
            index: index22,
...
function useSteps(props = {}) {
  ...
  const [activeStep, setActiveStep] = (0, import_react169.useState)(index2);
...
var Switch = forwardRef(function Switch2(props, ref) {
  ...
  const containerStyles = (0, import_react170.useMemo)(
    () => ({
      display: "inline-block",
      position: "relative",
      verticalAlign: "middle",
  ...
  const trackStyles = (0, import_react170.useMemo)(
    () => ({
      display: "inline-flex",
      flexShrink: 0,
  ...
  const labelStyles = (0, import_react170.useMemo)(
    () => ({
      userSelect: "none",
      marginStart: spacing,
      ...styles.label
...
function useTabs(props) {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react171.useState)(defaultIndex != null ? defaultIndex : 0);
...
function useTabPanels(props) {
  ...
  const children = validChildren.map(
    (child, index2) => (0, import_react171.createElement)(
      TabPanelProvider,
      {
        key: index2,
        value: {
...
function useTabPanel(props) {
  ...
  const hasBeenSelected = (0, import_react171.useRef)(false);
  if (isSelected) {
...
function useTabIndicator() {
  ...
  const isHorizontal = orientation === "horizontal";
  const isVertical = orientation === "vertical";
  const [rect, setRect] = (0, import_react171.useState)(() => {
    if (isHorizontal)
  ...
  const [hasMeasured, setHasMeasured] = (0, import_react171.useState)(false);
  useSafeLayoutEffect(() => {
...
var Tabs = forwardRef(function Tabs2(props, ref) {
  ...
  const context = (0, import_react172.useMemo)(() => ctx, [ctx]);
...
function useTooltip(props = {}) {
  ...
  const enterTimeout = (0, import_react173.useRef)();
  const clearEnterTimeout = (0, import_react173.useCallback)(() => {
    if (enterTimeout.current) {
      clearTimeout(enterTimeout.current);
      enterTimeout.current = void 0;
    }
  }, []);
  const exitTimeout = (0, import_react173.useRef)();
  const clearExitTimeout = (0, import_react173.useCallback)(() => {
    if (exitTimeout.current) {
      clearTimeout(exitTimeout.current);
      exitTimeout.current = void 0;
    }
  }, []);
  const closeNow = (0, import_react173.useCallback)(() => {
    clearExitTimeout();
    onClose();
  }, [onClose, clearExitTimeout]);
  const dispatchCloseEvent = useCloseEvent(ref, closeNow);
  const openWithDelay = (0, import_react173.useCallback)(() => {
  ...
  const closeWithDelay = (0, import_react173.useCallback)(() => {
    clearEnterTimeout();
    const win = getWin(ref);
    exitTimeout.current = win.setTimeout(closeNow, closeDelay);
  }, [closeDelay, closeNow, clearEnterTimeout]);
  const onClick = (0, import_react173.useCallback)(() => {
    if (isOpen && closeOnClick) {
      closeWithDelay();
    }
  }, [closeOnClick, closeWithDelay, isOpen]);
  const onPointerDown = (0, import_react173.useCallback)(() => {
  ...
  const getTriggerProps = (0, import_react173.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const triggerProps = {
        ...props2,
  ...
  const getTooltipPositionerProps = (0, import_react173.useCallback)(
    (props2 = {}, forwardedRef = null) => getPopperProps(
      {
        ...props2,
        style: {
  ...
  const getTooltipProps = (0, import_react173.useCallback)(
    (props2 = {}, ref2 = null) => {
      const styles = {
        ...props2.style,
        position: "relative",
...
var Tooltip = forwardRef((props, ref) => {
  ...
  if (shouldWrap) {
    ...
    const child = import_react174.Children.only(children);
    trigger2 = (0, import_react174.cloneElement)(
      child,
