var rrwebSnapshot = (function (exports) {
  ...
  function isNodeMetaEqual(a, b) {
      if (!a || !b || a.type !== b.type)
          return false;
      if (a.type === exports.NodeType.Document)
          return a.compatMode === b.compatMode;
      else if (a.type === exports.NodeType.DocumentType)
          return (a.name === b.name &&
              a.publicId === b.publicId &&
              a.systemId === b.systemId);
      else if (a.type === exports.NodeType.Comment ||
          a.type === exports.NodeType.Text ||
          a.type === exports.NodeType.CDATA)
          return a.textContent === b.textContent;
      else if (a.type === exports.NodeType.Element)
  ...
  function buildNodeWithSN(n, options) {
      ...
      if ((n.type === exports.NodeType.Document || n.type === exports.NodeType.Element) &&
          ...
          for (const childN of n.childNodes) {
              ...
              else if (n.type === exports.NodeType.Document &&
                  childN.type == exports.NodeType.Element) {
  ...
  function handleScroll(node, mirror) {
      ...
      if ((n === null || n === void 0 ? void 0 : n.type) !== exports.NodeType.Element) {
          return;
      }
      const el = node;
      for (const name in n.attributes) {
